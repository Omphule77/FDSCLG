 ...
 <!--  <h1 style="color:white;margin-top:150px;margin-left: 15%;" >Login Here</h1>
  ...
  <div class="forms">
    <div class="form login">
      ...
      <span class="title">Delivery Boy Login</span>
        <form action="dlogin" method="POST">
          ...
          <div class="input-field">               
            ...
            <input type="password" class="form-control password" placeholder="Enter your password" id="password" name="phone1" required>
