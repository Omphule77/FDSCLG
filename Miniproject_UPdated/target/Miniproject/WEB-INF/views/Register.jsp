       ...
       <div class="scrolling-container">
        ...
        <div class="input-field">
          ...
          <div class="input-field">
            ...
            <input type="text"class="form-control"  placeholder="Alternate Phone number" id="phone2" name="phone2" required><br>
       ...
       <span id="phoneError2" class="error" style="color: red;font-size: 14px"></span><br>
          ...
          <div class="input-field">               
           ...
           <div class="input-field">               
            ...
            <input type="text" class="form-control password" placeholder="For Security Question" id="password" name="fq" required>
        ...
        <div class="login-signup">
            <span class="text"
              >If you member?
              <a href="login" class="text">Loginup Now</a>
